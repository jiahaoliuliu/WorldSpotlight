...
"use strict";
  ...
  suffix : '' 
   ...
   var count01 = new countUp("count01", 0, 65, 0, 1, options);
  var count02 = new countUp("count02", 0, 10400, 0, 5, options);
  var count03 = new countUp("count03", 0, 1027, 0, 5, options);
  var count04 = new countUp("count04", 0, 60030, 0, 4, options);
